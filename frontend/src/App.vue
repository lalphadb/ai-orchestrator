<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-100">
    <!-- Header (Hidden on v8 routes) -->
    <header
      v-if="!$route.path.startsWith('/v8')"
      class="fixed top-0 left-0 right-0 z-50 bg-gray-900/80 backdrop-blur-md border-b border-gray-700/50"
    >
      <div class="max-w-full mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <nav class="flex items-center gap-2">
          ...
          <router-link
            to="/v8"
            class="px-3 py-1.5 rounded-lg text-sm font-bold bg-primary-600/20 text-primary-400 hover:bg-primary-600/30 transition-colors border border-primary-500/30"
          >
            🚀 V8 Dashboard
          </router-link>
        ...
        <div class="flex items-center gap-4">
          ...
          <div
            ...
            class="flex items-center gap-2 pl-4 border-l border-gray-700"
          >
    ...
    <!-- Main Content -->
    <main :class="{ 'pt-14': !$route.path.startsWith('/v8') }">
      <router-view />
    </main>
