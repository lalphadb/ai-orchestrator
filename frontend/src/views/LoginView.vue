  ...
  <div class="min-h-[calc(100vh-3.5rem)] flex items-center justify-center p-4">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        <div
          class="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-primary-500 to-purple-600 flex items-center justify-center"
        >
      ...
      <div class="flex mb-6 bg-gray-800/50 rounded-lg p-1">
        ...
        <button
          class="flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors"
          :class="
            mode === 'register' ? 'bg-primary-600 text-white' : 'text-gray-400 hover:text-white'
          "
          @click="mode = 'register'"
        >
          Inscription
...
// Clear any expired session data on login page load
onMounted(() => {
  auth.logout()
})
