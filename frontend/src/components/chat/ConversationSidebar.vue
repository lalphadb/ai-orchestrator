<template>
  <div class="h-full flex flex-col bg-gray-900/50 border-r border-gray-700/50">
    ...
    <div class="p-3 border-b border-gray-700/50">
      <button
        class="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-purple-600 hover:bg-purple-500 text-white rounded-lg transition-colors font-medium"
    ...
    <div class="p-3 border-b border-gray-700/50">
      <div class="relative">
        ...
        <input
          ...
          class="w-full pl-10 pr-4 py-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-sm text-gray-300 placeholder-gray-500 focus:outline-none focus:border-purple-500/50"
        />
      </div>
    </div>
    ...
    <div class="flex-1 overflow-y-auto">
      <div v-if="chat.conversationsLoading" class="flex items-center justify-center py-8">
        <div
          class="animate-spin w-6 h-6 border-2 border-purple-500 border-t-transparent rounded-full"
        ></div>
      </div>

      <div
        v-else-if="chat.filteredConversations.length === 0"
      ...
      <div v-else class="p-2 space-y-1">
        ...
        >
          ...
          <input
            ...
            ref="editInput"
            v-model="editTitle"
            class="w-full px-2 py-1 bg-gray-800 border border-purple-500 rounded text-sm text-white focus:outline-none"
    ...
    >
      <div class="bg-gray-800 rounded-xl p-6 max-w-sm w-full shadow-xl border border-gray-700">
        ...
        <p class="text-gray-400 text-sm mb-6">
          Cette action est irréversible. La conversation "{{ deleteModal.title || 'Sans titre' }}"
