  ...
  <div class="h-full flex flex-col bg-gray-900/50 border-l border-gray-700/50">
    ...
    >
      ...
      <select
        ...
        class="w-full px-2 py-1.5 bg-gray-800 border border-gray-700 rounded text-xs text-gray-300 focus:border-purple-500 focus:outline-none"
        @change="selectRun"
      >
    ...
    >
      <div>
        <div
          class="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-purple-500/20 to-purple-600/20 flex items-center justify-center"
        >
          <svg
    ...
    <div v-else class="flex-1 overflow-y-auto flex flex-col">
      ...
      <div class="flex border-b border-gray-700/30 bg-gray-800/20">
        <button
          ...
          :class="activeTab === tab.id ? 'text-purple-400' : 'text-gray-500 hover:text-gray-300'"
      ...
      <div class="flex-1 overflow-y-auto p-3">
        ...
        <div v-if="activeTab === 'thinking'" class="space-y-2">
          <div
            v-if="!run.thinking || run.thinking.length === 0"
...
function getPhaseClass(phase) {
  ...
  if (isPhaseActive(phase))
    return 'bg-purple-500/20 text-purple-400 border border-purple-500/50 ring-2 ring-purple-500/30 animate-pulse'
