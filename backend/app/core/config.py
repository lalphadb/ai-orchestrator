...
class Settings(BaseSettings):
    ...
    HOST: str = "0.0.0.0"
    PORT: int = 8001
    DEBUG: bool = True  # CRQ-2026-0203-001: Enable DEBUG logging to diagnose terminal event issues
    WORKERS: int = 1
    ...
    # SECURITY: localhost:8001 removed (backend should never CORS to itself)
    # For development, use .env to add http://localhost:3000 if needed
