...
from app.services.react_engine.governance import (
    GovernanceManager,
    ActionCategory,
    ActionContext,
    RollbackInfo
...
class TestActionClassification:
    ...
    def test_execute_command_by_role(self, governance):
        ...
        cat_operator = governance.classify_action(
            "execute_command",
            {"command": "docker ps", "role": "operator"}
        )
...
class TestRecordResult:
    ...
    async def test_record_success(self, governance):
        ...
        await governance.record_result(
            context.action_id,
            success=True,
            result={"content": "test"}
        )
